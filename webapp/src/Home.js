        ...
        <div className="contentContainer" style={{display: this.state.showPage ? 'block' : 'none'}} >
          ...
          <div className="pageContainer" style={{display: (this.state.page === this.state.one) ? 'block' : 'none'}}>
            ...
            */}
            ...
            <iframe src={this.state.spotify} className="streaming" frameBorder="0" allowtransparency="true" allow="encrypted-media" title="Nick Chase Spotify"></iframe>
                <br></br>
                <br></br>
                <iframe src={this.state.appleMusic} className="streaming" title="Nick Chase Apple Music" sandbox="allow-forms allow-popups allow-same-origin allow-scripts allow-storage-access-by-user-activation allow-top-navigation-by-user-activation"></iframe>
                <br></br>
                <br></br>
                <iframe className="streaming" src={this.state.soundcloud} title="Nick Chase Soundcloud"></iframe><div style={{fontSize: '10px', color: '#cccccc', lineBreak: 'anywhere', wordBreak: 'normal', overflow: 'hidden', whiteSpace: 'nowrap', textOverflow: 'ellipsis', fontFamily: 'Interstate,Lucida Grande,Lucida Sans Unicode,Lucida Sans,Garuda,Verdana,Tahoma,sans-serif', fontWeight: '100'}}></div>
